...
map -docstring "comment/uncomment selection (<c-/>)"                              global normal '<c-r>'     ': comment-line<ret>'
...
map -docstring "avoid escape key" global normal '<a-g>' ';<space>'
map -docstring "avoid escape key" global prompt '<a-g>' '<esc>'
map -docstring "avoid escape key" global insert '<a-g>' '<esc>'
...
# map -docstring "previous buffer"                global goto '<s-b>' '<esc>: buffer-previous<ret>'
